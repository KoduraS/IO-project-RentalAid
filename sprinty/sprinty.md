# Raport Stanu Prac Projektowych


## Szczegółowy przebieg prac (Sprinty)

### Spotkanie 1 (17.03.2026)
* **DONE:**
    * Strona tytułowa – *Szymon Kodura*
    * Wizja systemu – *Szymon Kodura, Albert Starosta, Marcin Będkowski*
* **TODO:**
    * Zebranie wymagań użytkowników (wywiad, ankieta itp.).
    * Opisanie wymagań w postaci historyjek użytkownika.
    * Podział na epiki i rozwinięcie części historyjek w kryteria akceptacji.

### Spotkanie 2 (14.04.2026)
* **DONE:**
    * Wymagania użytkowników – *Szymon Kodura, Albert Starosta, Marcin Będkowski*
    * Historyjki – *Albert Starosta, Marcin Będkowski*
* **TODO:**
    * Kompletne kryteria akceptacji i scenariusze testowe w formacie GWT.
    * Projekt flow użytkownika (diagram aktywności).
    * Wizualizacja interfejsu (interaktywny prototyp w wersji low-fidelity).

### Spotkanie 3 (05.05.2026)
* **DONE:**
...
* **TODO:**
    * Badania interfejsu w gronie użytkowników.
    * Finalizacja prototypu UI.
    * Architektura systemu (diagramy klas, pakietów, sekwencji).
...
* **TODO:**
    * Implementacja projektu (backend wraz z testami jednostkowymi).
